...
import { transactionCategories, Transaction } from "@/lib/transactionData";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
...
export default function Transactions() {
  ...
  return (
    <div 
      ...
      style={{
        backgroundImage: `linear-gradient(to bottom, rgba(0,51,102,0.92), rgba(0,51,102,0.88)), url('https://images.unsplash.com/photo-1562774053-701939374585?w=1920&q=80')`,
